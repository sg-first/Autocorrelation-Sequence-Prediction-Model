...
x=layers.Dense(4,activation="relu")(data_input)
...
predict_inf_model.compile(optimizer=adam(),loss="mse")
predict_inf_model.fit(train,label,epochs=20000,batch_size=9,callbacks=callback_list)
